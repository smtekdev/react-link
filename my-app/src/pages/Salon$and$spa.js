                ...
                <div className="row g-lg-4 g-3">
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">35% Off On Salon</a></h4>
                        <p className="dscr">35% Off On Salon</p>
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">40% Off On Salon</a></h4>
                        <p className="dscr">40% Off On Salon</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">30% Off On Hair Tint
                          </a></h4>
                        <p className="dscr">30% Off On Hair Tint</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">54% Off On Massage</a></h4>
                        <p className="dscr">54% Off On Massage</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">51% Off On Beach Spa
                          </a></h4>
                        <p className="dscr">51% Off On Beach Spa</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">43% Off On Spa
                          </a></h4>
                        <p className="dscr">43% Off On Spa</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
