                ...
                <div className="row">
                  <div className="col-xl-6 col-lg-5 col-md-6">
                    <div className="part-img mr-30">
                      <div className="img-box" id="bigPreview">
                        <img src="assets/images/cosco.webp" alt="Image" style={{maxWidth: '100%'}} />
                  ...
                  <div className="col-xl-6 col-lg-7 col-md-6">
                    <div className="part-txt">
                      <h2 className="main-product-title">Costco Promo Code</h2>
                      ...
                      <p className="dscr">Costco Promo Code
                      </p>
                      <form>
...
export default Costco$promo$code;