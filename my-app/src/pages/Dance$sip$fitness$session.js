...
function Dance$sip$fitness$session(){
        return(
            <>
                ...
                <div className="row">
                  ...
                  <div className="col-xl-6 col-lg-7 col-md-6">
                    <div className="part-txt">
                      <h2 className="main-product-title">Dance &amp; Sip Fitness Session</h2>
                      ...
                      <p className="dscr">Dance &amp; Sip Fitness Session</p>
                      <form>
...
export default Dance$sip$fitness$session;