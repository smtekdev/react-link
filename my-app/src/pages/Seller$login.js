...
function Seller$login(){
        return(
          <div>
        {/*------------------------------- BANNER SECTION STARTS HERE -------------------------------*/}
        {/*------------------------------- BANNER SECTION ENDS HERE -------------------------------*/}
        {/*------------------------------- TOP-PRODUCTS SECTION STARTS HERE -------------------------------*/}
        <section className="rev-7-top-product" style={{padding: '0px', marginTop: '2%'}}>
                        ...
                        <div class="top-product-tab-navs">
                            <div class="product-col col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                              ...
                              <div>
                                    ...
                                    <h4 class="product-name"><a href="#">Mark Henry</a></h4>
<p>Contact@example.com</p>
                                    <h5 class="product-name"><a href="#">Vendor Reviews</h5>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
          ...
          <div className="row">
            <div className="col-xl-8 col-lg-10 col-md-12 m-auto">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-8" style={{width: '100%'}}>
                  <div className="login_wrap widget-taber-content background-white">
                    <div className="padding_eight_all bg-white">
                      <div className="heading_s1">
                        <h1 className="mb-5">Seller Login</h1>
                        <p className="mb-30">Don't have an account? <a href="vendor-signup.html">Create here</a></p>
                      </div>
                      <form method="post">
                        ...
                        <div className="form-group">
                          <a href="seller-dashboard.html" style={{font: '21px !important'}} className="btn btn-xs">Seller Login <i className="fi-rs-arrow-small-right" /></a>
                          <a href="user-dashboard.html" style={{font: '21px !important'}} className="btn btn-xs">User Login <i className="fi-rs-arrow-small-right" /></a>
                        </div>
                      </form>
                    </div>
                  </div>
