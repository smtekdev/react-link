                    ...
                    <div className="row g-lg-4 g-3">
                      <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                        <div className="single-product-card">
                          ...
                          <div className="part-txt">
                            <h4 className="product-name"><a href="#">70% Off On Desert</a></h4>
                            <p className="dscr">70% Off Desert</p>
                      ...
                      <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                        <div className="single-product-card">
                          ...
                          <div className="part-txt">
                            <h4 className="product-name"><a href="#">50% Off On Meat With Veg</a></h4>
                            <p className="dscr">50% Off Meat With Veg</p>
                            <p className="price"><span>$96.00</span>$75.00</p>
                            <div className="star">
                              <i className="fa-solid fa-star-sharp rated" />
                              <i className="fa-solid fa-star-sharp rated" />
                      ...
                      <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                        <div className="single-product-card">
                          ...
                          <div className="part-txt">
                            <h4 className="product-name"><a href="#">35% Off On Pasta
                              </a></h4>
                            <p className="dscr">35% Off On Pasta</p>
                            <p className="price"><span>$96.00</span>$75.00</p>
                            <div className="star">
                              <i className="fa-solid fa-star-sharp rated" />
                              <i className="fa-solid fa-star-sharp rated" />
                      ...
                      <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                        <div className="single-product-card">
                          ...
                          <div className="part-txt">
                            <h4 className="product-name"><a href="#">40% Off On Iced Tea</a></h4>
                            <p className="dscr">40% Off On Iced Tea</p>
                            <p className="price"><span>$96.00</span>$75.00</p>
                            <div className="star">
                              <i className="fa-solid fa-star-sharp rated" />
                              <i className="fa-solid fa-star-sharp rated" />
                      ...
                      <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                        <div className="single-product-card">
                          ...
                          <div className="part-txt">
                            <h4 className="product-name"><a href="#">80% Off On Lemonade
                              </a></h4>
                            <p className="dscr">80% Off On Lemonade</p>
                            <p className="price"><span>$96.00</span>$75.00</p>
                            <div className="star">
                              <i className="fa-solid fa-star-sharp rated" />
                              <i className="fa-solid fa-star-sharp rated" />
                      ...
                      <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                        <div className="single-product-card">
                          ...
                          <div className="part-txt">
                            <h4 className="product-name"><a href="#">60% Off On Chilli Drink
                              </a></h4>
                            <p className="dscr">60% Off On Chilli Drink</p>
                            <p className="price"><span>$96.00</span>$75.00</p>
                            <div className="star">
                              <i className="fa-solid fa-star-sharp rated" />
                              <i className="fa-solid fa-star-sharp rated" />
