...
function Chicagoland$counselors(){
        return(
            <>
                ...
                <div className="row">
                  ...
                  <div className="col-xl-6 col-lg-7 col-md-6">
                    <div className="part-txt">
                      <h2 className="main-product-title">Chicagoland Counselors</h2>
                      ...
                      <p className="dscr">Chicagoland Counselors</p>
                      <form>
...
export default Chicagoland$counselors;