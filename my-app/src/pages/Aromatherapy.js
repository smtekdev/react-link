                ...
                <div className="row g-lg-4 g-3">
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Massage Aromatherapy
                          </a></h4>
                        <p className="dscr">Massage aromatherapy</p>
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Medical Aromatherapy
                          </a></h4>
                        <p className="dscr">Medical Aromatherapy</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Olfactory Aromatherapy
                          </a></h4>
                        <p className="dscr">Aromatherapy</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Psycho Aromatherapy
                          </a></h4>
                        <p className="dscr">Aromatherapy</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Organic Aromatherapy
                          </a></h4>
                        <p className="dscr">Aromatherapy</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Casual Aromatherapy
                          </a></h4>
                        <p className="dscr">Aromatherapy</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
