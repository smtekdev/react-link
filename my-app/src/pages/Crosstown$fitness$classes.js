...
function Crosstown$fitness$classes(){
        return(
            <>
                ...
                <div className="row">
                  ...
                  <div className="col-xl-6 col-lg-7 col-md-6">
                    <div className="part-txt">
                      <h2 className="main-product-title">CrossTown Fitness Classes</h2>
                      ...
                      <p className="dscr">CrossTown Fitness Classes</p>
                      <form>
...
export default Crosstown$fitness$classes;