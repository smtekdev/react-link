                  ...
                  <div className="login_wrap widget-taber-content background-white">
                    <div className="padding_eight_all bg-white">
                      <div className="heading_s1">
                        <h1 className="mb-5">Super Admin Login</h1>
                      ...
                      <form method="post">
                        ...
                        <div className="form-group">
                          <button type="submit" className="btn btn-heading btn-block hover-up" name="login">Super Admin Login</button>
                        </div>
                      </form>
                    </div>
                  </div>
...
export default Superadmin$login;