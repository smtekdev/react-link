...
function Saptherapy$physical$rehab(){
        return(
            <>
                ...
                <div className="row">
                  ...
                  <div className="col-xl-6 col-lg-7 col-md-6">
                    <div className="part-txt">
                      <h2 className="main-product-title">SapTherapy Physical Rehab</h2>
                      ...
                      <p className="dscr">SapTherapy Physical Rehab</p>
                      <form>
...
export default Saptherapy$physical$rehab;