                ...
                <div className="row g-lg-4 g-3">
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Premium Leather Bag</a></h4>
                        <p className="dscr">Premium Leather Bag</p>
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Red Men's Shirt</a></h4>
                        <p className="dscr">Red Men's Shirt</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Men Wool Coat</a></h4>
                        <p className="dscr">Men Wool Coat</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Red Heels</a></h4>
                        <p className="dscr">Red Heels</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Men's Brown Shoe
                          </a></h4>
                        <p className="dscr">Men's Brown Shoe</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Mens Jeans Shirt</a></h4>
                        <p className="dscr">Mens Jeans Shirt</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
