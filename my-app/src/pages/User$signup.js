...
function User$signup(){
                    ...
                    <div className="login_wrap widget-taber-content background-white">
                      <div className="padding_eight_all bg-white">
                        <div className="heading_s1">
                          <h2 className="mb-5">Create an User Account</h2>
                          <p className="mb-30">Already have an account? <a href="login.html">Login</a></p>
                        </div>
                        <form method="post">
                          ...
                          <div className="form-group mb-30">
                            <button type="link" className="btn btn-fill-out btn-block hover-up font-weight-bold" name="login">Submit &amp; Register</button>
                          </div>
                        </form>
                      </div>
                    </div>
        ...
        <div style={{width: '100%', height: '13px', borderBottom: '1px solid rgb(155, 155, 155)', textAlign: 'center', marginBottom: '2%'}}>
          <span style={{fontSize: '20px', backgroundColor: '#F3F5F6', padding: '0 10px'}}>
            or SignUp with{/*Padding is optional*/}
          </span>
        </div>
        <div style={{marginLeft: '35%', marginBottom: '2%'}}>
          <button className="social-signin facebook"><img src="assets/images/fb.png" style={{height: '35px'}} /></button>
          <button className="social-signin twitter"><img src="assets/images/twit.png" style={{height: '35px'}} /></button>
          <button className="social-signin google"><img src="assets/images/google.png" style={{height: '35px'}} /></button>
        </div>
        <p className="font-xs text-muted" style={{marginLeft: '10%', marginBottom: '2%'}}><strong>Note:</strong>Your personal data will be used to support your experience throughout this website, to manage access to your account, and for other purposes described in our privacy policy</p>
