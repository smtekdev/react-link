                ...
                <div className="row g-lg-4 g-3">
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Ballet
                          </a></h4>
                        <p className="dscr">Ballet</p>
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Ballroom
                          </a></h4>
                        <p className="dscr">Ballroom</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Hip Hop
                          </a></h4>
                        <p className="dscr">Hip Hop</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Folk Dance
                          </a></h4>
                        <p className="dscr">Folk Dance</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Irish Dance
                          </a></h4>
                        <p className="dscr">Irish Dance</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Swing Dance
                          </a></h4>
                        <p className="dscr">Swing Dance</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
