                    ...
                    <div>
                      ...
                      <div className="mobile-menu d-lg-none d-block">
                          ...
                          <ul className="menu-bar">
                            ...
                            <li className="nav-item dropdown">
                              ...
                              <ul className="dropdown-menu">
                                <li><a href="#" className="dropdown-item">Home Page 01</a></li>
                                <li><a href="#" className="dropdown-item">Home Page 02</a></li>
                                <li><a href="#" className="dropdown-item">Home Page 03</a></li>
                                <li><a href="#" className="dropdown-item">Home Page 04</a></li>
                                <li><a href="#" className="dropdown-item">Home Page 05</a></li>
                                <li><a href="#" className="dropdown-item">Home Page 06</a></li>
                                <li><a href="#" className="dropdown-item">Home Page 07</a></li>
                                <li><a href="#" className="dropdown-item">Home Page 08</a></li>
                              </ul>
                            </li>
                            ...
                            <li className="nav-item">
                              ...
                              <ul className="dropdown-menu">
                                ...
                                <li><a href="#" className="dropdown-item">Shop Right Bar</a></li>
                            ...
                            <li className="nav-item">
                              ...
                              <ul className="dropdown-menu">
                                <li><a href="#" className="dropdown-item">Blog Page</a></li>
                                <li><a href="#" className="dropdown-item">Blog Details Page</a></li>
                              </ul>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                              ...
                              <ul className="dropdown-menu">
                                <li><a href="#" className="dropdown-item">Cart Page</a></li>
                                <li><a href="#" className="dropdown-item">Compare Page</a></li>
                                <li><a href="#" className="dropdown-item">Wishlist Page</a></li>
                                <li><a href="#" className="dropdown-item">Register Page</a></li>
                              </ul>
                            </li>
                          </ul>
                        </div>
                        <ul className="mobile-nav">
                          ...
                          <li><a href="#" className="m-nav-link"><i className="fa-light fa-cart-shopping" /></a></li>
                          <li><a href="#" className="center"><i className="fa-light fa-house" /></a></li>
                          <li><a href="#" className="m-nav-link"><i className="fa-light fa-user-large" /></a></li>
                              ...
                              <div className="row g-lg-4 g-3">
                                <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                                  <div className="single-product-card">
                                    ...
                                    <div className="part-txt">
                                      <h4 className="product-name"><a href="#">MjB Creations Beauty Spa</a></h4>
                                ...
                                <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                                  <div className="single-product-card">
                                    ...
                                    <div className="part-txt">
                                      <h4 className="product-name"><a href="#">Sushi Making Class
                                        </a></h4>
                                      <p className="dscr">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus aliquid laborum aperiam dolores. Dignissimos at harum corporis qui illo nam fugit recusandae ratione odit neque officia, accusamus ab, assumenda odio.</p>
                                      <p className="price"><span>$96.00</span>$75.00</p>
                                      <div className="star">
                                ...
                                <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                                  <div className="single-product-card">
                                    ...
                                    <div className="part-txt">
                                      <h4 className="product-name"><a href="#">The Chicago Hotel Collection</a></h4>
                                      <p className="dscr">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus aliquid laborum aperiam dolores. Dignissimos at harum corporis qui illo nam fugit recusandae ratione odit neque officia, accusamus ab, assumenda odio.</p>
                                      <p className="price"><span>$96.00</span>$75.00</p>
                                      <div className="star">
                                        <i className="fa-solid fa-star-sharp rated" />
                                ...
                                <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                                  <div className="single-product-card">
                                    ...
                                    <div className="part-txt">
                                      <h4 className="product-name"><a href="#">Sophisticated Movement
                                        </a></h4>
                                      <p className="dscr">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus aliquid laborum aperiam dolores. Dignissimos at harum corporis qui illo nam fugit recusandae ratione odit neque officia, accusamus ab, assumenda odio.</p>
                                      <p className="price"><span>$96.00</span>$75.00</p>
                                      <div className="star">
                                ...
                                <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                                  <div className="single-product-card">
                                    ...
                                    <div className="part-txt">
                                      <h4 className="product-name"><a href="#">2-Hour Lakefront Tour
                                        </a></h4>
                                      <p className="dscr">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus aliquid laborum aperiam dolores. Dignissimos at harum corporis qui illo nam fugit recusandae ratione odit neque officia, accusamus ab, assumenda odio.</p>
                                      <p className="price"><span>$96.00</span>$75.00</p>
                                      <div className="star">
                                ...
                                <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                                  <div className="single-product-card">
                                    ...
                                    <div className="part-txt">
                                      <h4 className="product-name"><a href="#">Digital Marketing Service</a></h4>
                                      <p className="dscr">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus aliquid laborum aperiam dolores. Dignissimos at harum corporis qui illo nam fugit recusandae ratione odit neque officia, accusamus ab, assumenda odio.</p>
                                      <p className="price"><span>$96.00</span>$75.00</p>
                                      <div className="star">
                                        <i className="fa-solid fa-star-sharp rated" />
