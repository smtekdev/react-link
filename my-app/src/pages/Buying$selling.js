                ...
                <div className="row g-lg-4 g-3">
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Looking For Garden House</a></h4>
                        <p className="dscr">Looking For House With Garden</p>
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Looking For House</a></h4>
                        <p className="dscr">Looking For House</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Looking For Villa</a></h4>
                        <p className="dscr">Looking For Villa</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Garden For Sale</a></h4>
                        <p className="dscr">Garden For Sale</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">Villa For Sale </a></h4>
                        <p className="dscr">Villa For Sale</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
                  ...
                  <div className="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                    <div className="single-product-card">
                      ...
                      <div className="part-txt">
                        <h4 className="product-name"><a href="#">House For Sale</a></h4>
                        <p className="dscr">House For Sale</p>
                        <p className="price"><span>$96.00</span>$75.00</p>
                        <div className="star">
                          <i className="fa-solid fa-star-sharp rated" />
                          <i className="fa-solid fa-star-sharp rated" />
